"""run a noninteractive version of the PS1 cutout example"""
import os
...
from s3_fuse.ps1_utils import get_ps1_cutouts
from s3_fuse.utilz import make_loaders, parse_topline
...
TUNING = {
    "fitsio": {
        "image_chunksize": 40,
        "image_threads": cpu_count() * 5,
        "cut_threads": cpu_count() * 5
    },
    "greedy_fitsio": {
        "image_chunksize": 10,
